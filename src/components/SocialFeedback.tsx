...
const BACKGROUND_IMAGES = [
  ...
  { src: "/menu/Drinks/Mango Matcha Latte.jpeg", size: "w-28 h-28 md:w-40 md:h-40", pos: "top-[40%] left-[2%]" },
  { src: "/menu/Main Dish/General Tao's Chicken.jpeg", size: "w-32 h-32 md:w-44 md:h-44", pos: "bottom-[5%] left-[8%]" },
  { src: "/menu.webp", size: "w-24 h-24 md:w-36 md:h-36", pos: "top-[12%] right-[4%]" },
  { src: "/menu/Signature Snacks/Ice Cream Toast.jpeg", size: "w-28 h-28 md:w-36 md:h-36", pos: "top-[45%] right-[2%]" },
  { src: "/menu/Drinks/Taro Milk Tea.jpeg", size: "w-32 h-32 md:w-40 md:h-40", pos: "bottom-[8%] right-[6%]" },
